...
static const char *FileLoadOperationClassPathName = "org/verysampletelegram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "org/verysampletelegram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/verysampletelegram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/verysampletelegram/tgnet/RequestDelegateInternal;Lorg/verysampletelegram/tgnet/QuickAckDelegate;Lorg/verysampletelegram/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/verysampletelegram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/verysampletelegram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/verysampletelegram/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/verysampletelegram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/verysampletelegram/tgnet/ConnectionsManager"));
