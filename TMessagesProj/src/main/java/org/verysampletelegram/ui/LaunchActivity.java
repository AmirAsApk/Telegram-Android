...
import org.verysampletelegram.messenger.LocationController;
...
import org.verysampletelegram.messenger.NativeCrashManager;
...
import org.verysampletelegram.messenger.camera.CameraController;
...
import org.verysampletelegram.ui.Adapters.DrawerLayoutAdapter;
import org.verysampletelegram.ui.ActionBar.ActionBarLayout;
import org.verysampletelegram.ui.ActionBar.BaseFragment;
import org.verysampletelegram.ui.ActionBar.DrawerLayoutContainer;
import org.verysampletelegram.ui.Cells.LanguageCell;
import org.verysampletelegram.ui.Components.AudioPlayerAlert;
...
import org.verysampletelegram.ui.Components.PasscodeView;
...
import org.verysampletelegram.ui.Components.SharingLocationsAlert;
import org.verysampletelegram.ui.Components.StickersAlert;
import org.verysampletelegram.ui.ActionBar.Theme;
import org.verysampletelegram.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.verysampletelegram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
